...
class Admin {
    ...
    function printDetails() {
        echo"<img src='prof_pic/" . $this->image . ".jpg' alt='Cannot be displayed'/><br/><br/>";
        echo "<b>Name:</b> " . $this->firstname . " " . $this->lastname . "<br/><br/>";
        echo "<b>Nationality:</b> " . $this->nationality . "<br/><br/>";
        echo "<b>Gender:</b> " . $this->gender . "<br/><br/>";
        echo "<b>Street Name:</b> " . $this->address1 . "<br/><br/>";
        echo "<b>Block No:</b> " . $this->address2 . "<br/><br/>";
        echo "<b>Postal Code:</b> " . $this->address3 . "<br/><br/>";
        echo"<b>Company email: </b>" . $this->company_email . "<br/><br/>";
        echo"<b>Personal email: </b>" . $this->personal_email . "<br/><br/>";
    ...
    function printEditDetails() {
        ...
        echo"<p><Label>Street Address:</label><input class='text' type='text' name='address_line1' value='" . $this->address1 . "'/></p>";
        echo"<p><Label>Block No:</label><input class='text' type='text' name='address_line2' value='" . $this->address2 . "'/></p>";
        echo"<p><Label>Postal Code:</label><input class='text' type='text' name='address_line3' value='" . $this->address3 . "'/></p>";
        echo"<p><Label style='font-size:12.9px;'>Company email:</label><input class='text' type='text' name='company_email_address' value='" . $this->company_email . "'/></p>";
